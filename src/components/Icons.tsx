...
export const LogoIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 12.75a9.72 9.72 0 01-.223 1.836l-3.868-3.868" />
    </svg>
);
...
export const TelegramIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M21.05,3.05a1,1,0,0,0-1.14-.1L3.5,8.59a1,1,0,0,0,.09,1.86l4,1.26,1.26,4a1,1,0,0,0,1.86.09l5.64-14.41A1,1,0,0,0,21.05,3.05ZM13.43,14l-1-3.23,3.23,1A1,1,0,0,0,17,11.14l-4.14-4.14A1,1,0,0,0,11.14,8.23l1,3.23-3.23-1a1,1,0,0,0-1.23,1.23Z" />
    </svg>
);
